...
{ var x0,y0,i,j,itext,l,x,y,r,u,fn,dx,dy,xr,yr,invdifx,invdify,deltax,deltay,id=this.ID,lay=0,selObj="",divtext="",ii=0,oo,k,sub;
  ...
  { with(_DiagramTarget.document.layers[id])
    { top=this.top;
      left=this.left;
      document.open();
      document.writeln("<div style='position:absolute; left:1; top:1;'><table border=1 bordercolor="+theTextColor+" cellpadding=0 cellspacing=0><tr><td "+drawCol+"><a"+selObj+"><img src='"+drawImg+"' width="+eval(this.right-this.left-2)+" height="+eval(this.bottom-this.top-2)+" border=0 alt='"+_nvl(theTooltipText,"")+"'></a></td></tr></table></div>");
    }
  }
  else
  { _DiagramTarget.document.writeln("<layer id='"+this.ID+"' top="+this.top+" left="+this.left+" z-Index="+this.zIndex+">"); 
    _DiagramTarget.document.writeln("<div style='position:absolute; left:1; top:1;'><table border=1 bordercolor="+theTextColor+" cellpadding=0 cellspacing=0><tr><td "+drawCol+"><a"+selObj+"><img src='"+drawImg+"' width="+eval(this.right-this.left-2)+" height="+eval(this.bottom-this.top-2)+" border=0 alt='"+_nvl(theTooltipText,"")+"'></a></td></tr></table></div>");
  }
...
{ this.ID="Box"+_N_Box; _N_Box++; _zIndex++;
  ...
  var textCol=(_nvl(theTextColor,"")=="") ? "" : "color:"+theTextColor+";";
  _DiagramTarget.document.writeln("<layer id='"+this.ID+"' left="+theLeft+" top="+theTop+" z-Index="+_zIndex+">");
  _DiagramTarget.document.writeln("<layer style='position:absolute;left:1;top:1;'><table border="+ww+" "+bb+" cellpadding=0 cellspacing=0><tr><td "+drawCol+" width="+eval(theRight-theLeft-2*ww)+" height="+eval(theBottom-theTop-2*ww)+" align=center valign=top><a style='"+textCol+"text-decoration:none;"+_BFont+"'"+selObj+">"+tt+"</a></td></tr></table></layer>");
  _DiagramTarget.document.writeln("</layer>");
  return(this);
}
...
{ var id=this.ID, selObj;
  ...
  { document.open();
    if ((_nvl(this.BorderWidth,"")!="")&&(_nvl(this.BorderColor,"")!=""))
      document.writeln("<layer style='position:absolute;left:1;top:1;'><table border="+ww+" bordercolor="+this.BorderColor+" cellpadding=0 cellspacing=0><tr><td "+drawCol+" width="+eval(this.width-2*ww)+" height="+eval(this.height-2*ww)+" align=center valign=top><a style='"+textCol+"text-decoration:none;"+_BFont+"'"+selObj+">"+tt+"</a></td></tr></table></layer>");
    else
