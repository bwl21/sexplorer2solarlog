...
{ var x0,y0,i,j,itext,l,x,y,r,u,fn,dx,dy,xr,yr,invdifx,invdify,deltax,deltay,id=this.ID,lay=0,ii=0,oo,k,sub;
  ...
  var drawImg='Pictures/transparent.gif';
        ...
        { if (this.XSubGridColor)
          { for (k=1; k<this.SubGrids; k++)
            { if ((x0+k*sub>this.left+1)&&(x0+k*sub<this.right-1))
                writeln("<div style='position:absolute; left:"+Math.round(x0-this.left+k*sub)+"; top:1; font-size:1pt; line-height:1pt'><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.XSubGridColor+"><img src='Pictures/transparent.gif' width=1 height="+eval(this.bottom-this.top-1)+"></td></tr></table></div>");
            }
            if (this.SubGrids==-1)
            { for (k=0; k<8; k++)
              { if ((x0-this.logsub[k]*sub*_sign(deltax)>this.left+1)&&(x0-this.logsub[k]*sub*_sign(deltax)<this.right-1))
                  writeln("<div style='position:absolute; left:"+Math.round(x0-this.left-this.logsub[k]*sub*_sign(deltax))+"; top:1; font-size:1pt; line-height:1pt'><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.XSubGridColor+"><img src='Pictures/transparent.gif' width=1 height="+eval(this.bottom-this.top-1)+"></td></tr></table></div>");
              }
            }
          }
        }
        ...
        { itext++;
          ...
          { if (this.XScalePosition.substr(0,3)!="top")
            { if ((x0+sshift>=this.left)&&(x0+sshift<=this.right))
              ...
              writeln("<div style='position:absolute; left:"+eval(x0-this.left)+"; top:"+eval(this.bottom-5-this.top)+"; font-size:1pt; line-height:1pt'><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theTextColor+"><img src='Pictures/transparent.gif' width=1 height=12></td></tr></table></div>");
            }
            else
            { if ((x0+sshift>=this.left)&&(x0+sshift<=this.right))
              ...
              writeln("<div style='position:absolute; left:"+eval(x0-this.left)+"; top:-5; font-size:1pt; line-height:1pt'><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theTextColor+"><img src='Pictures/transparent.gif' width=1 height=12></td></tr></table></div>");
            }
            if ((this.XGridColor)&&(x0>this.left)&&(x0<this.right)) writeln("<div style='position:absolute; left:"+eval(x0-this.left)+"; top:1; font-size:1pt; line-height:1pt'><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.XGridColor+"><img src='Pictures/transparent.gif' width=1 height="+eval(this.bottom-this.top-1)+"></td></tr></table></div>");
          }
        }
      }
    }
        ...
        { if (this.YSubGridColor)
          { for (k=1; k<this.SubGrids; k++)
            { if ((y0+k*sub>this.top+1)&&(y0+k*sub<this.bottom-1))
                writeln("<div style='position:absolute; left:1; top:"+Math.round(y0-this.top+k*sub)+"; font-size:1pt; line-height:1pt'><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.YSubGridColor+" valign=top><img src='Pictures/transparent.gif' height=1 width="+eval(this.right-this.left-1)+"></td></tr></table></div>");
            }
            if (this.SubGrids==-1)
            { for (k=0; k<8; k++)
              { if ((y0+this.logsub[k]*sub*_sign(deltay)>this.top+1)&&(y0+this.logsub[k]*sub*_sign(deltay)<this.bottom-1))
                  writeln("<div style='position:absolute; left:1; top:"+Math.round(y0-this.top+this.logsub[k]*sub*_sign(deltay))+"; font-size:1pt; line-height:1pt'><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.YSubGridColor+" valign=top><img src='Pictures/transparent.gif' height=1 width="+eval(this.right-this.left-1)+"></td></tr></table></div>");
              }
            }
          }
        }
        ...
        { itext++;
          ...
          { if (this.YScalePosition.substr(0,5)!="right")
            { if ((y0+sshift>=this.top)&&(y0+sshift<=this.bottom))
              ...
              writeln("<div style='position:absolute; left:-5; top:"+eval(y0-this.top)+"; font-size:1pt; line-height:1pt'><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theTextColor+" valign=top><img src='Pictures/transparent.gif' height=1 width=11></td></tr></table></div>");
            }
            else
            { if ((y0+sshift>=this.top)&&(y0+sshift<=this.bottom))
              ...
              writeln("<div style='position:absolute; left:"+eval(this.right-this.left-5)+"; top:"+eval(y0-this.top)+"; font-size:1pt; line-height:1pt'><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theTextColor+" valign=top><img src='Pictures/transparent.gif' height=1 width=11></td></tr></table></div>");
            }
            if ((this.YGridColor)&&(y0>this.top)&&(y0<this.bottom)) writeln("<div style='position:absolute; left:1; top:"+eval(y0-this.top)+"; font-size:1pt; line-height:1pt'><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.YGridColor+" valign=top><img src='Pictures/transparent.gif' height=1 width="+eval(this.right-this.left-1)+"></td></tr></table></div>");
          }
        }
      }
    }
...
{ this.ID="Bar"+_N_Bar; _N_Bar++; _zIndex++;
  ...
  if ((tt=="")||(tt==this.Text)) tt="<img src='Pictures/transparent.gif' width="+eval(this.width-1)+" height="+eval(this.height-1)+" border=0 alt='"+_nvl(theTooltipText,"")+"'>";
  else tt=this.Text;
...
{ this.ID="Box"+_N_Box; _N_Box++; _zIndex++;
  ...
  var tt="";
  while (tt.length<this.Text.length) tt=tt+" ";
  if ((tt=="")||(tt==this.Text)) tt="<img src='Pictures/transparent.gif' width="+eval(this.width-2*ww)+" height="+eval(this.height-2*ww)+" border=0 alt='"+_nvl(theTooltipText,"")+"'>";
  else tt=this.Text;
...
{ var id=this.ID;
  ...
  var tt="";
  while (tt.length<this.Text.length) tt=tt+" ";
  if ((tt=="")||(this.Text==tt)) tt="<img src='Pictures/transparent.gif' width="+eval(this.width-2*ww)+" height="+eval(this.height-2*ww)+" border=0 alt='"+_nvl(this.TooltipText,"")+"'>";
  else tt=this.Text;
...
{ this.Size=theSize;
  ...
  { if (theType%6==0)
    { _DiagramTarget.document.writeln("<layer left=1 top="+Math.round(this.Size/4+0.3)+"><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theColor+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+eval(this.Size-1)+" height="+eval(this.Size+1-2*Math.round(this.Size/4+0.3))+" border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></dt></tr></table></layer>");
      _DiagramTarget.document.writeln("<layer left="+Math.round(this.Size/4+0.3)+" top=1><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theColor+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+eval(this.Size+1-2*Math.round(this.Size/4+0.3))+" height="+eval(this.Size-1)+" border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></dt></tr></table></layer>");
    }
    if (theType%6==1)
    { _DiagramTarget.document.writeln("<layer left="+Math.round(this.Size/2-this.Size/8)+" top=0><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theColor+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(this.Size/4)+" height="+this.Size+" border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></dt></tr></table></layer>");
      _DiagramTarget.document.writeln("<layer left=0 top="+Math.round(this.Size/2-this.Size/8)+"><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theColor+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+this.Size+" height="+Math.round(this.Size/4)+" border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></dt></tr></table></layer>");
    }
    if (theType%6==2)
      _DiagramTarget.document.writeln("<layer left=0 top=0><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theColor+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+this.Size+" height="+this.Size+" border=0 align=top valign=left></a></dt></tr></table></layer>");
    if (theType%6==3)
    ...
    if (theType%6==4)
    { _DiagramTarget.document.writeln("<layer left=0 top="+Math.round(this.Size/2-this.Size/8)+"><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theColor+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+this.Size+" height="+Math.round(this.Size/4)+" border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></dt></tr></table></layer>");
      _DiagramTarget.document.writeln("<layer left="+Math.round(this.Size/4)+" top=0><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theColor+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(this.Size/2)+" height="+this.Size+" border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></dt></tr></table></layer>");
    }
    if (theType%6==5)
      _DiagramTarget.document.writeln("<layer left="+Math.round(1+this.Size/12)+" top="+Math.round(1+this.Size/12)+"><a"+this.EventActions+" style='color:"+theColor+"'><img src='Pictures/transparent.gif' border="+Math.round(this.Size/6)+" width="+Math.round(this.Size-this.Size/3)+" height="+Math.round(this.Size-this.Size/3)+" align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
  }
  _DiagramTarget.document.writeln("</layer>");
  return(this);
}
...
{ if (theColor!="") this.Color=theColor;
  ...
  { document.open();
    ...
    { if (this.Type%6==0)
      { document.writeln("<layer left=1 top="+Math.round(this.Size/4+0.3)+"><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+eval(this.Size-1)+" height="+eval(this.Size+1-2*Math.round(this.Size/4+0.3))+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
        document.writeln("<layer left="+Math.round(this.Size/4+0.3)+" top=1><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+eval(this.Size+1-2*Math.round(this.Size/4+0.3))+" height="+eval(this.Size-1)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
      }
      if (this.Type%6==1)
      { document.writeln("<layer left="+Math.round(this.Size/2-this.Size/8)+" top=0><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(this.Size/4)+" height="+this.Size+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
        document.writeln("<layer left=0 top="+Math.round(this.Size/2-this.Size/8)+"><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+this.Size+" height="+Math.round(this.Size/4)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
      }
      if (this.Type%6==2)
        document.writeln("<layer left=0 top=0><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+this.Size+" height="+this.Size+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
      if (this.Type%6==3)
      { document.writeln("<layer left=0 top="+Math.round(this.Size/4)+"><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+this.Size+" height="+Math.round(this.Size/2)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
        document.writeln("<layer left="+Math.round(this.Size/2-this.Size/8)+" top=0><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(this.Size/4)+" height="+this.Size+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
      }
      if (this.Type%6==4)
      { document.writeln("<layer left=0 top="+Math.round(this.Size/2-this.Size/8)+"><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+this.Size+" height="+Math.round(this.Size/4)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
        document.writeln("<layer left="+Math.round(this.Size/4)+" top=0><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(this.Size/2)+" height="+this.Size+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
      }
      if (this.Type%6==5)
        document.writeln("<layer left="+Math.round(1+this.Size/12)+" top="+Math.round(1+this.Size/12)+"><a"+this.EventActions+" style='color:"+this.Color+"'><img src='Pictures/transparent.gif' border="+Math.round(this.Size/6)+" width="+Math.round(this.Size-this.Size/3)+" height="+Math.round(this.Size-this.Size/3)+" align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
    }
    document.close();
  }
}
...
{ this.ID="Pix"+_N_Pix; _N_Pix++; _zIndex++;
  ...
  this.MoveTo=_DotMoveTo;
  this.Delete=_Delete;
  _DiagramTarget.document.writeln("<layer id='"+this.ID+"' left="+eval(theX+this.dX)+" top="+eval(theY+this.dY)+" z-Index="+_zIndex+"><layer left=0 top=0 width=1 height=2 bgcolor="+theColor+"><img src='Pictures/transparent.gif' width=1 height=2></layer></layer>");
  return(this);
}
...
{ this.Color=theColor;
  with(_DiagramTarget.document.layers[this.ID])
  { document.open();
    document.writeln("<layer left=0 top=0 width=1 height=2 bgcolor="+theColor+"><img src='Pictures/transparent.gif' width=1 height=2></layer>");
    document.close();
  }
}
...
{ this.ID="Line"+_N_Line; _N_Line++; _zIndex++;
  ...
  if ((ww==0)||(hh==0))
    _DiagramTarget.document.writeln("<layer left=2 top=2 width="+eval(ww+this.Size)+" height="+eval(hh+this.Size)+" bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+eval(ww+this.Size)+" height="+eval(hh+this.Size)+" border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
  else
  { if (ww>hh)
    { ccr=0;
      cct=0;
      ...
      { ccl=ccr;
        ...
        _DiagramTarget.document.writeln("<a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+eval(ccr-ccl+this.Size)+" height="+this.Size+" border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
        cct++;
      }
    }
    else
    { ccb=0;
      ...
      { cct=ccb;
        ...
        _DiagramTarget.document.writeln("<a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+this.Size+" height="+eval(ccb-cct+this.Size)+" border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
        ccl++;
      }
    }
  }
...
{ var xx0, yy0, xx1, yy1, ll, rr, tt, bb, ww, hh, ccl, ccr, cct, ccb, id=this.ID;
  ...
  { top=tt-ss2;
    ...
    document.open();
    if ((ww==0)||(hh==0))
      document.writeln("<layer left=2 top=2 width="+eval(ww+this.Size)+" height="+eval(hh+this.Size)+" bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+eval(ww+this.Size)+" height="+eval(hh+this.Size)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
    else
    { if (ww>hh)
      { ccr=0;
        cct=0;
        ...
        { ccl=ccr;
          ...
          document.writeln("<a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+eval(ccr-ccl+this.Size)+" height="+this.Size+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
          cct++;
        }
      }
      else
      { ccb=0;
        ...
        { cct=ccb;
          ...
          document.writeln("<a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+this.Size+" height="+eval(ccb-cct+this.Size)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
          ccl++;
        }
      }
    }
  ...
  { if (this.Angle0<this.Angle1)
    { for (yy=-this.Radius+0.5; yy<this.Radius; yy++)
      { xx=Math.round(Math.sqrt(rr2-(yy)*(yy)));
        tt=Math.round(yy+this.Radius+2-0.5);
        _DiagramTarget.document.writeln("<layer left="+Math.round(this.Radius+2-xx)+" top="+tt+" width="+Math.round(2*xx)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(2*xx)+" height=1 border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
      }
    }
  }
  else
    ...
    { xx=Math.round(Math.sqrt(rr2-(yy)*(yy)));
      ...
      { if ((yy<yy0)&&(yy<yy1))
        { if (((xx0<0)&&(xx1>0))||((xx0<0)&&(xx1<=xx0))||((xx1>0)&&(xx0>=xx1)))
          ...
          if (xx0<xx1)
            _DiagramTarget.document.writeln("<layer left="+Math.round(this.Radius+2+ss0)+" top="+tt+" width="+Math.round(ss1-ss0)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(ss1-ss0)+" height=1 border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
          else
          { _DiagramTarget.document.writeln("<layer left="+Math.round(this.Radius+2-xx)+" top="+tt+" width="+Math.round(ss1+xx)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(ss1+xx)+" height=1 border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
            _DiagramTarget.document.writeln("<layer left="+Math.round(this.Radius+2+ss0)+" top="+tt+" width="+Math.round(xx-ss0)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(xx-ss0)+" height=1 border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
          }
        }
        else if (yy>=yy0)
        { ss0=yy*xx0/yy0;
    ...
    { xx=Math.round(Math.sqrt(rr2-(yy)*(yy)));
      ...
      { if ((yy>yy0)&&(yy>yy1))
        { if (((xx1<0)&&(xx0>0))||((xx1<0)&&(xx0<=xx1))||((xx0>0)&&(xx1>=xx0)))
          ...
          ss1=Math.round(yy*xx1/yy1);
          if (xx0>xx1)
            _DiagramTarget.document.writeln("<layer left="+Math.round(this.Radius+2+ss1)+" top="+tt+" width="+Math.round(ss0-ss1)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(ss0-ss1)+" height=1 border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
          else
          { _DiagramTarget.document.writeln("<layer left="+Math.round(this.Radius+2-xx)+" top="+tt+" width="+Math.round(ss0+xx)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(ss0+xx)+" height=1 border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
            _DiagramTarget.document.writeln("<layer left="+Math.round(this.Radius+2+ss1)+" top="+tt+" width="+Math.round(xx-ss1)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(xx-ss1)+" height=1 border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
          }
        }
        else if (yy<=yy0)
        { ss0=yy*xx0/yy0;
  ...
  { top=Math.round(this.YCenter-this.Radius+yyo);
    ...
    { if (this.Angle0<this.Angle1)
      { for (yy=-this.Radius+0.5; yy<this.Radius; yy++)
        { xx=Math.round(Math.sqrt(rr2-(yy)*(yy)));
          tt=Math.round(yy+this.Radius+2-0.5);
          document.writeln("<layer left="+Math.round(this.Radius+2-xx)+" top="+tt+" width="+Math.round(2*xx)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(2*xx)+" height=1 border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
        }
      }
    }
    else
      ...
      { xx=Math.round(Math.sqrt(rr2-(yy)*(yy)));
        ...
        { if ((yy<yy0)&&(yy<yy1))
          { if (((xx0<0)&&(xx1>0))||((xx0<0)&&(xx1<=xx0))||((xx1>0)&&(xx0>=xx1)))
            ...
            ss1=Math.round(yy*xx1/yy1);
            if (xx0<xx1)
              document.writeln("<layer left="+Math.round(this.Radius+2+ss0)+" top="+tt+" width="+Math.round(ss1-ss0)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(ss1-ss0)+" height=1 border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
            else
            { document.writeln("<layer left="+Math.round(this.Radius+2-xx)+" top="+tt+" width="+Math.round(ss1+xx)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(ss1+xx)+" height=1 border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
              document.writeln("<layer left="+Math.round(this.Radius+2+ss0)+" top="+tt+" width="+Math.round(xx-ss0)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(xx-ss0)+" height=1 border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
            }
          }
          else if (yy>=yy0)
          { ss0=yy*xx0/yy0;
      ...
      { xx=Math.round(Math.sqrt(rr2-(yy)*(yy)));
        ...
        { if ((yy>yy0)&&(yy>yy1))
          { if (((xx1<0)&&(xx0>0))||((xx1<0)&&(xx0<=xx1))||((xx0>0)&&(xx1>=xx0)))
            ...
            ss1=Math.round(yy*xx1/yy1);
            if (xx0>xx1)
              document.writeln("<layer left="+Math.round(this.Radius+2+ss1)+" top="+tt+" width="+Math.round(ss0-ss1)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(ss0-ss1)+" height=1 border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
            else
            { document.writeln("<layer left="+Math.round(this.Radius+2-xx)+" top="+tt+" width="+Math.round(ss0+xx)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(ss0+xx)+" height=1 border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
              document.writeln("<layer left="+Math.round(this.Radius+2+ss1)+" top="+tt+" width="+Math.round(xx-ss1)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='Pictures/transparent.gif' width="+Math.round(xx-ss1)+" height=1 border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
            }
          }
          else if (yy<=yy0)
          { ss0=yy*xx0/yy0;
