...
function printRES_DayBody( var1, var2, var3, var4, var5 ) {
  document.write("<\/style><\/head><body style='background-image:url(Pictures/bg_palm.jpg); background-repeat:no-repeat'><map name='Browse'><area shape='rect' coords='0,0,21,25' href='palm.html?"+var1+"&"+var2+"' alt='back'><area shape='rect' coords='25,0,46,25' href='palm.html?"+var3+"&"+var4+"' alt='forw'><\/map><div id='browseb'><img src='Pictures/e.gif' width='46' height='25' alt='Browse' usemap='#Browse' border='0'><\/div><map name='Button'><area shape='rect' coords='0,0,106,27' href='palm.html?min&000' alt='day'><area shape='rect' coords='107,0,209,27' href='palm.html?day&000' alt='month'><area shape='rect' coords='210,0,319,27' href='palm.html?month&000' alt='year'><\/map><div id='buttonb'><img src='Pictures/e.gif' width='319' height='27' alt='Button' usemap='#Button' border='0'><\/div>")
}

function printRES_InitDayBalken() {
  document.write("<div id='balken'><img src='Pictures/e.gif' width='0' height='129'>")
}

function printRES_BalkenBlackGif( var1, var2 ) {
  document.write("<img src='Pictures/black.gif' width='"+var1+"' height='"+var2+"'>")
}

function printRES_emptyGif( var1, var2) {
  document.write("<img src='Pictures/e.gif' width='"+var1+"' height='"+var2+"'>")
}
...
function printRES_YSkalY( var1 ) {
  document.write("<div id='Y"+var1+"'><img src='Pictures/black.gif' width='10' height='1'><\/div>")
}

function printRES_YSkalYS( var1 ) {
  document.write("<div id='YS"+var1+"'><img src='Pictures/ydot.gif' width='274' height='1'><\/div>")
}

function printRES_XSkalBlackGif( var1 ) {
  document.write("<div id='X"+var1+"'><img src='Pictures/black.gif' width='1' height='10'><\/div>")
}
  ...
  while( index1>-1 ) {
    ...
    if( dt.substring(0,8)==sDate ) {
      ...
      if( dDate.getHours()>=hourStart && dDate.getHours()<=hourEnd ) {
        ...
        h=Math.floor(dy*10/100)    // defaulth�he f�r Ausnahmen
        if( firstDraw ) {   // erster Balken
          ...
          if( h > 0 ) {
            document.write("<img src='Pictures/b.gif' width='"+w+"' height='"+h+"'>")
