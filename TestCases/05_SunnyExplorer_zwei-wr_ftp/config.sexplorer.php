 ...
 */
define('USE_FTP', true);
define('FTP_SERVER', 'photonensammler.homedns.org');
define('FTP_USERNAME', 'Bernhard.Weichel@Testanlage1');
define('FTP_PASSWORD', 'hhKwR2%2-1');
define('FTP_PORT', 21);
/*
 ...
 */
define('FTP_INVERTER_DATA_PATH', 'SExplorerData');
